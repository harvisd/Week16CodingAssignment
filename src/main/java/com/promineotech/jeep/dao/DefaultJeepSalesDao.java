...
public class DefaultJeepSalesDao implements JeepSalesDao {
 ...
 private NamedParameterJdbcTemplate template;
  ...
  public List<Jeep> fetchJeeps(JeepModel model, String trim) {
    log.info("For the DAO model={}, trim={}", model, trim);
    ...
    return template.query(sql, paramMap,
                          new RowMapper<Jeep>() {
          
        @Override
         public Jeep mapRow(ResultSet rs, int rowNumber) throws SQLException {  //or rowNumber?
          return Jeep.builder()
