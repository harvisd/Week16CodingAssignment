...
public class DefaultJeepOrderService implements JeepOrderService {
  ...
  public Order createOrder(OrderRequest orderRequest) {
    ...
    //the instruction got a little confusing here, so I am not 100% certain this is right
    return jeepOrderDao.saveOrder(customer, jeep, color, engine, tire, calculatedPrice, option);
  }
